...
namespace DemoPostgres
{
    public partial class FormMain : Form
    {
        ...
        private void MapperApplicant(List<Applicant> data)
        {
            ...
            dataGrid.Columns[0].Name = "ФИО";
            dataGrid.Columns[1].Name = "Номер телефона";
            dataGrid.Columns[2].Name = "Адрес";

            foreach (Applicant i in data)
            {
                dataGrid.Rows.Add(i.fio, i.nuberTelephone, i.adress);
            }
        }
        ...
        private void MapperDormitory(List<Dormitory> data)
        {
            ...
            dataGrid.Columns[0].Name = "Адрес";
            dataGrid.Columns[1].Name = "Количество комнат";
            dataGrid.Columns[2].Name = "Условия проживания";
            dataGrid.Columns[3].Name = "Тип общежития";
            ...
            {
                dataGrid.Rows.Add(i.adress, i.countRoom, i.condition, typeD[i.typeDormitory]);
            }
        }
        ...
        private void ApplicationToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            dataGrid.Columns[0].Name = "Номер заявления";
            dataGrid.Columns[1].Name = "Дата заявления";
            dataGrid.Columns[2].Name = "Тип документа";
            dataGrid.Columns[3].Name = "Сотрудник";
            dataGrid.Columns[4].Name = "Заявитель";
            ...
            {
                dataGrid.Rows.Add(i.numberApplication, i.date, typeD[i.typeDocument], emplD[i.employee], appD[i.applicant]);
            }
        }
        ...
        private void PermissionToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            dataGrid.Columns[0].Name = "Номер разрешения";
            dataGrid.Columns[1].Name = "Дата разрешения";
            dataGrid.Columns[2].Name = "Сотрудник";
            dataGrid.Columns[3].Name = "Комната";
            dataGrid.Columns[4].Name = "Общежитие";
            ...
            {
                dataGrid.Rows.Add(i.numberPermission, i.date, emplD[i.employee], rD[i.room], dormD[i.dormitory], appD[i.applicant]);
            }
        }
        ...
        private void OrderToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            dataGrid.Columns[0].Name = "Номер приказа";
            dataGrid.Columns[1].Name = "Дата приказа";
            dataGrid.Columns[2].Name = "Тип документа";
            dataGrid.Columns[3].Name = "Сотрудник";
            ...
            {
                dataGrid.Rows.Add(i.number, i.date, typeD[i.typeDocument], emplD[i.employee], rD[i.room], dormD[i.dormitory], appD[i.applicant]);
            }
        }
        ...
        private void ReceiptToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            dataGrid.Columns[0].Name = "Номер квитанции";
            dataGrid.Columns[1].Name = "Дата квитанции";
            dataGrid.Columns[2].Name = "Сумма";
            dataGrid.Columns[3].Name = "Сотрудник";
            dataGrid.Columns[4].Name = "Комната";
            dataGrid.Columns[5].Name = "Общежитие";
            dataGrid.Columns[6].Name = "Заявитель";
            ...
            {
                dataGrid.Rows.Add(i.number, i.date, i.summ, emplD[i.employee], rD[i.room], dormD[i.dormitory], appD[i.applicant]);
            }
        }
        ...
        private void reportToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            dataGrid.Columns[0].Name = "Номер отчёта";
            dataGrid.Columns[1].Name = "Дата отчёта";
            dataGrid.Columns[2].Name = "Оценка пожаробезопасности";
            dataGrid.Columns[3].Name = "Оценка состояния систем";
            dataGrid.Columns[4].Name = "Оценка состояния дома";
            dataGrid.Columns[5].Name = "Инспектор";
